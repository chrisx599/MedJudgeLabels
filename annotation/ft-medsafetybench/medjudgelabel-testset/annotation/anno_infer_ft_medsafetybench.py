...
功能:
- 加载微调的LoRA适配器 (train-med-safety-bench/outputs/lora_adapter)
...
def main():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-medsafetybench_pku_anno_formatted_test',
                        help='输出目录')
