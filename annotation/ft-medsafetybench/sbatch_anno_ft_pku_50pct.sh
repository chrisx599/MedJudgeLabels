...
#SBATCH --job-name=anno_ft_medsafetybench      # Give the job a name
...
cd /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-medsafetybench_pku_anno_formatted_test

# Submit your job to the cluster
# Pass all command-line arguments to the Python script
srun --gres=gpu:1 python /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-medsafetybench_pku_anno_formatted_test/anno_infer_ft_medsafetybench.py "$@"
