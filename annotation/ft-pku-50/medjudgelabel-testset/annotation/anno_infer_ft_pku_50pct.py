...
基于train_orig/inference.py的推理能力和anno_prompt.txt的标注规则

功能:
- 加载微调的LoRA适配器 (train_pku50percent/outputs/lora_adapter)
- 对pku_anno_formatted_test.jsonl进行推理
- 输出标注结果到ft_pku_orig_qwen3-8b/目录
"""
import json
import torch
...
def main():
    ...
    parser.add_argument('--lora_adapter_path', type=str,
                        default='/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/train_pku50percent/outputs/lora_adapter',
                        help='LoRA适配器路径')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-pku50pct_pku_anno_formatted_test',
                        help='输出目录')
