...
if __name__ == "__main__":
    ...
    predictions_file = script_dir / "ft-pku_pku_anno_formatted_test_labels_20251105_151248_50percent.jsonl"
    # ground truth file should be in .../MedJudgeLabels/data/
    ground_truth_file = script_dir.parent.parent.parent / "data" / "MedQuad_Dataset_aligned.jsonl"
