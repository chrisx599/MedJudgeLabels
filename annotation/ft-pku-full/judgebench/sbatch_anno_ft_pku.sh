...
#SBATCH --job-name=anno_ft_pku_medsafety              # Give the job a name
...
python /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-pku_pku_anno_formatted_test/judgebench/anno_infer_medsafety_labels.py
