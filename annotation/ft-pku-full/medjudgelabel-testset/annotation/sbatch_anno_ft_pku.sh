...
#SBATCH --error=%u.%j.err           # Where should the error files go?
...
#SBATCH --mail-user=zyliang@smu.edu.sg # Who should receive the email notifications
#SBATCH --job-name=anno_ft_pku              # Give the job a name
...
cd /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-pku_pku_anno_formatted_test

# Submit your job to the cluster
# Pass all command-line arguments to the Python script
srun --gres=gpu:1 python /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-pku_pku_anno_formatted_test/anno_infer_ft_pku.py "$@"
