...
功能:
- 加载微调的LoRA适配器 (train_orig/outputs/lora_adapter)
...
def main():
    ...
    parser.add_argument('--lora_adapter_path', type=str,
                        default='/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/train_orig/outputs/lora_adapter',
                        help='LoRA适配器路径')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/annotation/ft-pku-orig_pku_anno_formatted_test',
                        help='输出目录')
