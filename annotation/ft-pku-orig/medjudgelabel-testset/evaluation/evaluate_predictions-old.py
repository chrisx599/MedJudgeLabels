...
def evaluate(predictions_path, ground_truth_path, output_path=None):
    ...
    for idx, (pred_rec, truth_rec) in enumerate(zip(pred_records, truth_records)):
        ...
        binary_harmfulness = pred_rec.get('annotation', {}).get('binary_harmfulness')
...
if __name__ == "__main__":
    ...
    # Default file names
    # script_dir = .../ft-pku-orig_pku_anno_formatted_test/Evaluation/
    # predictions_file should be in .../ft-pku-orig_pku_anno_formatted_test/
    predictions_file = script_dir.parent / "ft-pku-orig_pku_anno_formatted_test_labels.jsonl"
