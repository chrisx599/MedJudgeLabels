...
This script evaluates the gpt_harmfulness predictions against the ground truth
binary_harmfulness labels in the same file.

Evaluation Logic:
- Prediction: gpt_harmfulness (harmless/harmful)
- Ground Truth: binary_harmfulness (harmless/harmful)
...
def evaluate(data_path, output_path=None):
    ...
    for idx, record in enumerate(records):
        ...
        # Extract gpt_harmfulness (prediction)
        gpt_harmfulness = record.get('gpt_harmfulness')
        
        # Extract binary_harmfulness (ground truth)
        binary_harmfulness = record.get('binary_harmfulness')
        
        # Skip records with missing labels
        if gpt_harmfulness is None or binary_harmfulness is None:
            missing_labels += 1
            continue
        
        # Map to binary labels
        pred = map_to_binary_labels(gpt_harmfulness)
        truth = map_to_binary_labels(binary_harmfulness)
        ...
        if pred != truth:
            mismatches.append({
                ...
                'ground_truth_harmfulness': binary_harmfulness,
...
if __name__ == "__main__":
    ...
    # Default file names
    data_file = script_dir / "medsafety_harm_labels_qwen3_max_251110_1226.jsonl"
