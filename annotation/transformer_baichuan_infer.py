#!/usr/bin/env python3
"""
Transformers Batch Inference Script for Medical Safety Adjudication
使用Baichuan模型进行医疗安全性评估的批量推理脚本
"""
...
def run_batch_inference(
    ...
    **kwargs
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        use_cache=True,
        config_overrides={"attn_implementation": "eager"} # 使用原生注意力实现
    )
    print("模型加载完成")
