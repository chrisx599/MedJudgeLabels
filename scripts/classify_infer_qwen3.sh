...
python classify/vllm_qwen3_4b_infer.py \
    --input /common/home/projectgrps/CS707/CS707G2/PKU-SafeRLHF/data/train.jsonl \
    --output /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/data/pku_data_v2.jsonl
