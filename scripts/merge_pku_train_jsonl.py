...
input_data_path = os.path.join(data_dir, 'pku_anno_formatted_train.jsonl')
output_data_path = os.path.join(data_dir, 'pku_anno_formatted_train_orig.jsonl')
...
# Read pku_anno_formatted_train.jsonl and perform left join
...
print("Successfully created pku_anno_formatted_train_orig.jsonl")
