...
def format_output(binary_harmfulness, severity, harm_types, explanation):
    """格式化输出"""
    output = {
    ...
    with open(input_file, 'r', encoding='utf-8') as f:
        for line_num, line in enumerate(f, 1):
            ...
            try:
                ...
                # 提取必要字段
                query = item['query']
                response = item['meta_data']['response']
                ...
                output = format_output(binary_harmfulness, severity, harm_types, explanation)
...
if __name__ == "__main__":
    # 测试数据准备
    input_file = "../data/pku_anno.jsonl"
    output_file = "../data/pku_anno_formatted.jsonl"
