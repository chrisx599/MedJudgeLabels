...
#SBATCH --output=logs/train_%j.out   # 标准输出日志 (%j会被作业ID替换)
...
# 进入训练目录
cd /common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/train_pku50percent
...
TRAIN_DATA_PATH="/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/data/pku_anno_formatted_train_50pct.jsonl"
TEST_DATA_PATH="/common/home/projectgrps/CS707/CS707G2/MedJudgeLabels/data/pku_anno_formatted_test_50pct.jsonl"
OUTPUT_DIR="./outputs"
